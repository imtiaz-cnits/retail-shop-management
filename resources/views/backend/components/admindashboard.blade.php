    ...
    <div class="page-content">
        <div class="container-fluid px-0">
            ...
            <div id="adminOnlyFinancialSections">
                <!-- ROW 1: TODAY'S KEY METRICS (Trendy Design) -->
                <div class="row g-3 mb-4">
                    <!-- Today Net Profit -->
                    <div class="col-xl-3 col-md-6" id="todayNetProfitCol">
                        <div class="card dashboard-metric-card metric-profit h-100 p-3 shadow-sm border-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <span class="text-muted small fw-bold text-uppercase d-block mb-1" style="letter-spacing: 0.5px;">Today's Net Profit</span>
                                    <h2 id="todayNetProfit" class="fw-bold mb-0 text-success fs-3">৳ 0.00</h2>
                                    <small class="text-muted">Net after COGS & Expenses</small>
                                </div>
                                <div class="rounded-3 p-3 text-white d-flex align-items-center justify-content-center shadow-sm" style="width: 50px; height: 50px; background: linear-gradient(135deg, #10b981, #059669); border-radius: 12px !important;">
                    ...
                    <div class="col-xl-3 col-md-6 today-metric-col">
                        <div class="card dashboard-metric-card metric-sales h-100 p-3 shadow-sm border-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <span class="text-muted small fw-bold text-uppercase d-block mb-1" style="letter-spacing: 0.5px;">Today's Total Sales</span>
                                ...
                                <div class="rounded-3 p-3 text-white d-flex align-items-center justify-content-center shadow-sm" style="width: 50px; height: 50px; background: linear-gradient(135deg, #3b82f6, #1d4ed8); border-radius: 12px !important;">
                    ...
                    <div class="col-xl-3 col-md-6 today-metric-col">
                        <div class="card dashboard-metric-card metric-collection h-100 p-3 shadow-sm border-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <span class="text-muted small fw-bold text-uppercase d-block mb-1" style="letter-spacing: 0.5px;">Today's Cash Collection</span>
                                    <h2 id="todayCashCollection" class="fw-bold mb-0 style-purple fs-3" style="color: #6366f1;">৳ 0.00</h2>
                                    <small class="text-muted">Total cash received today</small>
                                </div>
                                <div class="rounded-3 p-3 text-white d-flex align-items-center justify-content-center shadow-sm" style="width: 50px; height: 50px; background: linear-gradient(135deg, #6366f1, #4f46e5); border-radius: 12px !important;">
                    ...
                    <!-- Today Expense -->
                    <div class="col-xl-3 col-md-6 today-metric-col">
                        <div class="card dashboard-metric-card metric-expense h-100 p-3 shadow-sm border-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <span class="text-muted small fw-bold text-uppercase d-block mb-1" style="letter-spacing: 0.5px;">Today's Expense</span>
                                    <h2 id="todayExpense" class="fw-bold mb-0 text-warning fs-3">৳ 0.00</h2>
                                    <small class="text-muted">Shop daily expenses</small>
                                </div>
                                <div class="rounded-3 p-3 text-white d-flex align-items-center justify-content-center shadow-sm" style="width: 50px; height: 50px; background: linear-gradient(135deg, #f59e0b, #d97706); border-radius: 12px !important;">
                ...
                <!-- ROW 2: GRAPHICAL ANALYTICS CHARTS (Trendy Design) -->
                <div class="row g-4 mb-4">
                    <!-- Sales vs Net Profit Area Trend Chart -->
                    <div class="col-lg-8">
                        <div class="card dashboard-content-card border-0 shadow-sm h-100">
                ...
                <!-- ROW 3: THIS MONTH'S FINANCIAL SUMMARY (Trendy Design) -->
                <div class="card dashboard-content-card border-0 shadow-sm mb-4">
                    <div class="card-header py-3 border-0 d-flex justify-content-between align-items-center">
                        <h5 class="fw-bold text-dark mb-0 fs-6">
                            <i class="fa-solid fa-calendar-check text-success me-2"></i> This Month's Financial Summary ({{ date('F Y') }})
                        </h5>
                        <span class="badge bg-success-subtle text-success border border-success-subtle fw-bold px-3 py-1 rounded-pill">Monthly Ledger</span>
                    </div>
                    <div class="card-body p-4 pt-0">
                        <div class="row g-3">
                            <div class="col-md-3 col-6" id="monthlyNetProfitCol">
                                <div class="p-3 bg-light-subtle rounded-3 text-center border">
                            ...
                            <div class="col-md-3 col-6 monthly-summary-col">
                                <div class="p-3 bg-light-subtle rounded-3 text-center border">
                                    ...
                                    <h4 id="monthlyCollection" class="fw-bold style-purple mb-0" style="color: #6366f1;">৳ 0.00</h4>
                                </div>
                            </div>
                            <div class="col-md-3 col-6 monthly-summary-col">
                                <div class="p-3 bg-light-subtle rounded-3 text-center border">
                ...
                <!-- ROW 4: OUTSTANDING DUES & INVENTORY VALUATION (Trendy Design) -->
                <div class="row g-3 mb-4">
                    <!-- Customer Outstanding Due -->
                    <div class="col-xl-3 col-md-6">
                        <div class="card dashboard-metric-card metric-due-customer h-100 p-3 shadow-sm border-0">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="text-muted small fw-bold text-uppercase" style="letter-spacing: 0.5px;">Customer Due</span>
                                <span class="badge bg-danger-subtle text-danger border border-danger-subtle px-2 py-1 rounded-pill">Receivable</span>
                            </div>
                            <h3 id="customerDue" class="fw-bold text-danger mb-1">৳ 0.00</h3>
                            <div class="d-flex justify-content-between align-items-center mt-2">
                                <small class="text-muted">Total customer dues</small>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card dashboard-metric-card metric-due-supplier h-100 p-3 shadow-sm border-0">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="text-muted small fw-bold text-uppercase" style="letter-spacing: 0.5px;">Supplier Due</span>
                                <span class="badge bg-warning-subtle text-dark border border-warning-subtle px-2 py-1 rounded-pill">Payable</span>
                            </div>
                            <h3 id="supplierPayable" class="fw-bold text-orange mb-1" style="color: #ea580c;">৳ 0.00</h3>
                            <div class="d-flex justify-content-between align-items-center mt-2">
                                <small class="text-muted">Total supplier dues</small>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card dashboard-metric-card metric-stock-cost h-100 p-3 shadow-sm border-0">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="text-muted small fw-bold text-uppercase" style="letter-spacing: 0.5px;">Stock Cost Value</span>
                                <span id="productCountBadge" class="badge bg-teal-subtle text-teal border px-2 py-1 rounded-pill" style="background-color: #ccfbf1; color: #0d9488;">0 Items</span>
                            </div>
                            <h3 id="costStockValue" class="fw-bold mb-1" style="color: #0d9488;">৳ 0.00</h3>
                            <small class="text-muted d-block mt-2">Total inventory cost</small>
                        </div>
                    </div>

                    <!-- Inventory Selling Valuation -->
                    <div class="col-xl-3 col-md-6">
                        <div class="card dashboard-metric-card metric-stock-sell h-100 p-3 shadow-sm border-0">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="text-muted small fw-bold text-uppercase" style="letter-spacing: 0.5px;">Stock Selling Value</span>
                                <span id="lowStockBadge" class="badge bg-danger text-white px-2 py-1 rounded-pill">0 Low Stock</span>
                            </div>
                            <h3 id="sellStockValue" class="fw-bold text-success mb-1">৳ 0.00</h3>
                            <small class="text-muted d-block mt-2">Total estimated sales value</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- ROW 5: QUICK SHORTCUTS GRID (Trendy Design) -->
            <div class="card dashboard-content-card border-0 shadow-sm mb-4">
                <div class="card-header py-3 border-0">
                    <h5 class="fw-bold text-dark mb-0 fs-6">
                ...
                <div class="card-body p-4 pt-0">
                    <div class="row g-3">
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="/admin-dashboard-pos" class="shortcut-btn btn btn-outline-success w-100 d-flex flex-column align-items-center gap-2 border-2">
                                <i class="fa-solid fa-cart-shopping fs-3"></i>
                                <span class="fw-bold small">New POS Sale</span>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="/admin-dashboard-product" class="shortcut-btn btn btn-outline-primary w-100 d-flex flex-column align-items-center gap-2 border-2">
                                <i class="fa-solid fa-box-open fs-3"></i>
                                <span class="fw-bold small">Add Product</span>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="/admin-dashboard-Purchase" class="shortcut-btn btn btn-outline-info w-100 d-flex flex-column align-items-center gap-2 border-2">
                                <i class="fa-solid fa-truck-ramp-box fs-3"></i>
                                <span class="fw-bold small">Purchase Stock</span>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="/admin-dashboard-customer" class="shortcut-btn btn btn-outline-purple w-100 d-flex flex-column align-items-center gap-2 border-2" style="color: #6366f1; border-color: #6366f1;">
                                <i class="fa-solid fa-users fs-3"></i>
                                <span class="fw-bold small">Customers</span>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="/admin-dashboard-supplier" class="shortcut-btn btn btn-outline-dark w-100 d-flex flex-column align-items-center gap-2 border-2">
                                <i class="fa-solid fa-truck-field fs-3"></i>
                                <span class="fw-bold small">Suppliers</span>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="/admin-dashboard-customer-due-list" class="shortcut-btn btn btn-outline-danger w-100 d-flex flex-column align-items-center gap-2 border-2">
            ...
            <!-- ROW 6: 2-COLUMN TABLES (Low Stock Alerts & Recent Sales - Trendy Design) -->
            <div class="row g-4 mb-4">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", async () => {
        // Show table skeleton shimmers on initial dashboard load
        showTableSkeleton('lowStockTbody', 4, 3);
        showTableSkeleton('recentSalesTbody', 4, 3);
        loadDashboardData();
    });
