                ...
                <div id="popup-modal">
                    <form onsubmit="return Save(event)" id="signup">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="form-row">
                                    <input type="text" placeholder="Enter Customer Number *" id="CustomerMobile" required />
                                </div>
                            </div>
                            <div class="col-lg-6 mb-3">
                                <div class="form-row">
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="form-row">
                                    <input type="text" placeholder="Enter Nid Number" id="CustomerNIDNumber" />
                                </div>
                            </div>

                            <div class="col-lg-6 mb-3">
                                <div class="form-row">
                                    <input type="number" step="any" placeholder="Enter Previous Due Amount" id="PreviousDueAmount" />
                                </div>
                            </div>
                            <div class="col-lg-6 mb-3">
                                <div class="form-row">
