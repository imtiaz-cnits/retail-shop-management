    ...
    function renderPaginatedList() {
        ...
        let filtered = window.allProductsList.filter(function (item) {
            ...
            let matchSearch = !searchTerm || productName.includes(searchTerm) || categoryName.includes(searchTerm) || codeStr.includes(searchTerm);
            ...
            pageItems.forEach(function (item, idx) {
                ...
                let row = `
                    <tr>
                        ...
                        <td class="text-center fw-bold">${engToBanglaNum(item.quantity)} ${unitName}</td>
                    ...
                    <div class="product-mobile-card card border shadow-sm rounded-4 mb-3 p-3 position-relative bg-white">
                        ...
                        <div class="row g-2 bg-light p-2 rounded-3 my-2 text-center align-items-center" style="border: 1px solid #f1f5f9;">
                            <div class="col-4 border-end">
                                ...
                                <span class="fw-bold text-dark" style="font-size: 12px;">${engToBanglaNum(item.quantity)} ${unitName}</span>
                            </div>
                            <div class="col-4 border-end">
